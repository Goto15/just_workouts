...
struct ExercisesData {
  ...
  Exercise( name: "Atlas Stones",
                  primaryMuscles: "lower back",
                  secondaryMuscles: "abdominals,adductors,biceps,calves,forearms,glutes,hamstrings,middle back,quadriceps,traps",
                  force: "pull",
                  level: "expert",
                  mechanic: "compound",
                  equipment: "other",
  ...
  Exercise( name: "Clean and Jerk",
                  primaryMuscles: "shoulders",
                  secondaryMuscles: "abdominals,glutes,hamstrings,lower back,quadriceps,traps,triceps",
                  force: "push",
                  level: "expert",
                  mechanic: "compound",
                  equipment: "barbell",
  ...
  Exercise( name: "Conan's Wheel",
                  primaryMuscles: "quadriceps",
                  secondaryMuscles: "abdominals,biceps,calves,forearms,lower back,shoulders,traps",
                  force: "",
                  level: "intermediate",
                  mechanic: "compound",
                  equipment: "other",
  ...
  Exercise( name: "Hang Clean",
                  primaryMuscles: "quadriceps",
                  secondaryMuscles: "calves,forearms,glutes,hamstrings,lower back,shoulders,traps",
                  force: "pull",
                  level: "intermediate",
                  mechanic: "compound",
                  equipment: "barbell",
  ...
  Exercise( name: "Keg Load",
                  primaryMuscles: "lower back",
                  secondaryMuscles: "abdominals,biceps,calves,forearms,glutes,hamstrings,middle back,quadriceps,shoulders,traps",
                  force: "pull",
                  level: "intermediate",
                  mechanic: "compound",
                  equipment: "other",
  ...
  Exercise( name: "Kipping Muscle Up",
                  primaryMuscles: "lats",
                  secondaryMuscles: "abdominals,biceps,forearms,middle back,shoulders,traps,triceps",
                  force: "pull",
                  level: "intermediate",
                  mechanic: "compound",
                  equipment: "other",
  ...
  Exercise( name: "Log Lift",
                  primaryMuscles: "shoulders",
                  secondaryMuscles: "abdominals,chest,glutes,hamstrings,lower back,middle back,quadriceps,traps,triceps",
                  force: "push",
                  level: "intermediate",
                  mechanic: "compound",
                  equipment: "other",
  ...
  Exercise( name: "Power Stairs",
                  primaryMuscles: "hamstrings",
                  secondaryMuscles: "adductors,calves,glutes,lower back,quadriceps,shoulders,traps",
                  force: "pull",
                  level: "intermediate",
                  mechanic: "compound",
                  equipment: "other",
                  category: "strongman",
                  instructions: "In the power stairs, implements are moved up a staircase. For training purposes, these can be performed with a tire or box. Begin by taking the implement with both hands. Set your feet wide, with your head and chest up. Drive through the ground with your heels, extending your knees and hips to raise the weight from the ground. As you lean back, attempt to swing the weight onto the stairs, which are usually around 16-18 inches high. You can use your legs to help push the weight onto the stair. Repeat for 3-5 repetitions, and continue with a heavier weight, moving as fast as possible."
      ),
  ...
  Exercise( name: "Reverse Band Box Squat",
                  primaryMuscles: "quadriceps",
                  secondaryMuscles: "abductors,adductors,calves,forearms,glutes,hamstrings,lower back",
                  force: "push",
                  level: "intermediate",
                  mechanic: "compound",
                  equipment: "barbell",
  ...
  Exercise( name: "Reverse Band Sumo Deadlift",
                  primaryMuscles: "hamstrings",
                  secondaryMuscles: "abductors,adductors,calves,forearms,glutes,lower back,quadriceps,traps",
                  force: "pull",
                  level: "expert",
                  mechanic: "compound",
                  equipment: "barbell",
  ...
  Exercise( name: "Rickshaw Carry",
                  primaryMuscles: "forearms",
                  secondaryMuscles: "abdominals,calves,glutes,hamstrings,lower back,quadriceps,traps",
                  force: "",
                  level: "intermediate",
                  mechanic: "compound",
                  equipment: "other",
  ...
  Exercise( name: "Sandbag Load",
                  primaryMuscles: "quadriceps",
                  secondaryMuscles: "abdominals,biceps,calves,forearms,glutes,hamstrings,lower back,middle back,shoulders,traps",
                  force: "pull",
                  level: "beginner",
                  mechanic: "compound",
                  equipment: "other",
  ...
  Exercise( name: "Tire Flip",
                  primaryMuscles: "quadriceps",
                  secondaryMuscles: "calves,chest,forearms,glutes,hamstrings,lower back,shoulders,traps,triceps",
                  force: "pull",
                  level: "intermediate",
                  mechanic: "compound",
                  equipment: "other",
  ...
  Exercise( name: "Yoke Walk",
                  primaryMuscles: "quadriceps",
                  secondaryMuscles: "abdominals,abductors,adductors,calves,glutes,hamstrings,lower back",
                  force: "",
                  level: "intermediate",
                  mechanic: "compound",
                  equipment: "other",
